= Antora UI for AeroGear
// Settings:
:experimental:
:hide-uri-scheme:
// Project URIs:
:uri-project: https://github.com/aerogear/antora-ui/
...
Based on https://gitlab.com/antora/antora-ui-default
...
----
ui:
  bundle: https://github.com/aerogear/antora-ui/raw/master/build/ui-bundle.zip
----

See link:https://github.com/aerogear/mobile-docs[Mobile Docs] for more information.
